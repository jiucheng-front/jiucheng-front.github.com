function swt2(){
 var sHTML = [
        '<style type="text/css">',
        '.topTips {height:0px;overflow:hidden; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; position: fixed; left:0; top: 0; width: 100%; z-index: 100;-webkit-perspective: 600px; perspective: 600px; z-index:9999999;}',
        ...
        '.tipsInner a { height:48px;text-decoration:none;display: block; position: relative; padding-left: 50px; color: #FFFFFF; filter:alpha(opacity=80); -moz-opacity:0.8; -khtml-opacity: 0.8; opacity: 0.8;background-color:black;}',
        ...
        '   <div class="tipsInner">',
        "       <a href=\"javascript:void(0)\" onclick=\"openZoosUrl('chatwin','&amp;e=dingbuweixin');LR_HideInvite();return false;\" class=\"JS-SWT-PLACEHOLD\" target=\"_blank\">",     
        '         <img src="images/wx.png" alt="">',
        '         <dl>',
        '           <dt>微信   <font style="font-size:12px;color:#D4D4D4;margin-left:10px;">现在</font></dt>',
        '           <dd>皮肤病在线咨询：请问有什么可以帮您?</dd>',
        '         </dl>',
        '       </a>',
        '   </div>',
        '</div>'].join('\r\n');
